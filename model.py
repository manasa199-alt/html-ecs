...
def result():
    ...
    if file.filename.endswith('.csv'):
        ...
        return render_template('result.html', category_percentages=json.dumps(category_percentages))
    else:
